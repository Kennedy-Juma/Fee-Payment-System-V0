...
<a href="studentdashboard.jsp" class="btn btn-success btn-md active pull-right" role="button" aria-pressed="true">
<i class="fas fa-home"></i> Back To Homepage</a>				
<a href="#" class="btn btn-primary btn-md active pull-right" role="button" aria-pressed="true" id="pdf">
<i class="fas fa-save"></i> Save Transactions</a>
			</div>
