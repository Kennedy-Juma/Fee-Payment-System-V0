...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item active"><a class="nav-link" href="student-change-password.jsp">Change Password</a></li>
                ...
                <div class="inforide">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-4 rideone">
                        <img src="images/Mpesa-logo.jpg" alt="">
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-8 col-8 fontsty">
                        <h4><a href="MpesaPayment.jsp">M-Pesa Payment</a></a></h4>
                        </div>
                  </div>
                </div>
            </div>
                ...
                <div class="inforide">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-4 ridetwo">
                        <img src="images/contactless-card-payments.jpg" alt="">
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-8 col-8 fontsty">
                        <h4><a href="CardPayment.jsp" target="_blank">Card Payment</a></a></h4>
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="inforide">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-4 ridethree">
                       <img src="images/school-fees.png" alt="">
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-8 col-8 fontsty">
                        <h4><a href="https://students.umma.ac.ke/" target="_blank">Fee Statement</a></a></h4>
                    </div>
                  </div>
                </div>
            </div>
